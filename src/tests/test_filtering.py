...
class TestFiltering(unittest.TestCase):
    ...
    def test_remove_literals(self):
        ...
        outgoing_filtered = filtering.remove_literals(triple_df=outgoing)
    ...
    def test_add_superclass(self):
        ...
        ingoing = read_csv(
            ...
            ["subject", "predicate", "object"])
        ingoing = filtering.remove_literals(triple_df=ingoing)
        ...
        filtering.add_superclass_to_class(df_pd=ingoing, type_node='ingoing')
        self.assertTrue(filtering.domain == domain_expected)
        self.assertTrue(filtering.superclasses == superclasses_expected)
    ...
    def test_add_superclass_to_df(self):
        ...
        filtering.superclasses = superclasses

        ingoing_superclass = filtering.add_superclass_to_df(triple_df=ingoing,
                                                            type_node="ingoing")
    ...
    def test_update_info_filter(self):
        ...
        ingoing_superclass_filtered, info = filtering.update_info_filter(
